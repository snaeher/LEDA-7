...
int main()
{
  ...
  cv_view<gw_view,gw_box_element>    sv1(1000,200,"Array View");
  sv1.win_init(-10,10*n,-15);
  sv1.display(200,200);


  cv_view<gw_view,gw_stick_element>  sv2(490,450,"Stick View");
  ...
  cv_view<gw_view,gw_dot_element>    sv3(490,450,"Dot View");
