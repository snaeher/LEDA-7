...
cout << "\
We compare the map types of LEDA (leda::map/leda::d_array) and the C++ \n\
standard libary (std::map). To see a considerably difference you should\n\
use a large number of entries e.g. N >= 1 Million.\n";
...
cout << endl;
  ...
  cout << "key type: int                leda::map     std::map" << endl;
  cout << "----------------------------------------------------" << endl;
...
/*
  cout << "leda::d_array : std::map     leda::d_array std::map" << endl;
  cout << "----------------------------------------------------" << endl;
...
*/
  ...
  cout << "key type: double             leda::map     std::map" << endl;
  cout << "----------------------------------------------------" << endl;
