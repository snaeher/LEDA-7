...
void set_window_close_handler(void (*F)(window*)) 
{ BASE_WINDOW::set_window_close_handler((win_close_handler_func)F);}
/*{\Mopl     sets the window close handler function to $F$.}*/

void set_window_close_object(const window_handler& obj)
{ BASE_WINDOW::set_window_close_object(obj); }
/*{\Mopl     sets the window delete object to $obj$.}*/
...
/*{\Mopl     sets the background redraw function to $F$.}*/

void set_bg_redraw(const window_handler& obj) 
{ BASE_WINDOW::set_bg_redraw(obj); }
/*{\Mopl     sets the background redraw object to $obj$.}*/
...
int get_mouse(unsigned long timeout);
/*{\Mop     non-blocking read operation (with timeout). If a button is pressed 
            within $timeout$ msec its number is returned, otherwise the 
            constant NO\_BUTTON is returned. }*/


int get_mouse(double& x, double& y, unsigned long timeout);
/*{\Mopl    if a mouse button is pressed within $timeout$ milliseconds the 
            corresponding position is assigned to $(x,y)$ and the button number
            is returned, otherwise the constant NO\_BUTTON is returned. }*/


int get_mouse();
/*{\Mop     non-blocking read operation, i.e., if a button is pressed 
            its number is returned, otherwise the constant NO\_BUTTON is 
            returned. }*/

int get_mouse(double& x, double& y);
/*{\Mopl    if a mouse button is pressed the corresponding position is
...
void disable_button(int b) { BASE_WINDOW::disable_button(b); }
/*{\Mopl  disables button $b$. }*/

void enable_button(int b) { BASE_WINDOW::enable_button(b); }
...
{ BASE_WINDOW::disable_panel(disable_items); }
/*{\Mopl  disables the entire panel section of $W$. }*/

void enable_panel()  
{ BASE_WINDOW::enable_panel(); }
...
void redraw_panel(panel_item it) { BASE_WINDOW::draw_item(it); }
